        ...
        return (
            <div className="socrata-container">
                ...
                <div className="combination">
                    ...
                    <div className="logos">
                        <img className="logo" id="tLogo" src={tylerLogo} /> <img className="plus" src={plus} /> <img className="logo" src={socrataLogo} /> </div>
                </div>
...
to connect data and processes across the disparate systems of government.</p>
                ...
                <div className="data-wrapper">
                    <div className="data-box" id="pic-left">
                        <img src={surfaceData} />
                    ...
                    <div className="data-box" id="pic-right">
                        <img src={discover} />
                        <div className="data-content">
                ...
                <div className="conclusion">
                    ...
                    <div className="sec2">
                        <div className="sec2-box">
                            <img className="logo" id="tLogo" src={tylerLogo} />
